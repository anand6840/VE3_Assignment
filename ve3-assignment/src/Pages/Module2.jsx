...
import M2I1 from "../Images/m2t1.png";
import M2I2 from "../Images/m2t2.png";
import M2I3 from "../Images/m1t3.png";
        ...
        <Tabs size="large">
          ...
          <TabPanels>
            <TabPanel className="tab1">
              <div>
                <img className="m1i1" src={M2I1} alt="m1i1" />
              </div>
            ...
            <TabPanel className="tab1">
              <div>
                <img className="m1i1" src={M2I3} alt="m1i1" />
              </div>
              <div className="text-data">
                <Heading>Fusce sem magna </Heading>
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quia
                  reprehenderit ullam, eveniet laborum aliquam aspernatur eius
                  reiciendis a magni pariatur dolore eaque ducimus temporibus
